package com.example.athul.chat3.Adapter;
...
import com.example.athul.chat3.R;
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatMessageAdapter(Context context, ArrayList<ChatMessage> data) {
        super(context, R.layout.item_mine_mesage, data);
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewType == MY_MESSAGE) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_mine_mesage, parent, false);
